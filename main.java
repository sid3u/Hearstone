...
public class main {
	public static void main(String[] args) {
		...
		// Création des cartes
		ICarte chassemareemurlocvincent = new Serviteur("Chasse-marée murloc",
				1, 2, 2, crideguerre, joueur1);
		ICarte chassemareemurlocnassym = new Serviteur("Chasse-marée murloc",
				1, 2, 2, crideguerre, joueur2);
